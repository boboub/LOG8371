...
public class EdgeTreeTests extends ESTestCase {
    ...
    public void testGetShapeType() {
        ...
        assertThat(new EdgeTreeWriter(Arrays.asList(pointCoord, pointCoord), Arrays.asList(pointCoord, pointCoord),
                TestCoordinateEncoder.INSTANCE, false).getShapeType(), equalTo(ShapeType.MULTILINESTRING));
    }
}
